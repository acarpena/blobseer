...

{
...

	{
...

		{
			...
			printf("[timer] %lf closing file associated with step %d\n",step);
...

{
...

	{
		...
		if(rk == 0) {	
			...
			printf("[timer] %lf opening file for step %d\n",t,step);
...

{
	...
	printf("[timer] %lf start writing variable\n",t);
	...
	free(chunkdims);
        ...
        printf("[timer] %lf en writing variable\n",t);
