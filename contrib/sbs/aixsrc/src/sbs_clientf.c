...
int sbs_initialize_f(int64_t* handler, int* tid, int* ierr)
...
int sbs_start_step_f(int64_t* handler, uint64_t* step)
...
int sbs_end_step_f(int64_t* handler, uint64_t* step)
...
int sbs_write_f(int64_t* handler, const char* varname, void* data, int* type,
...
int sbs_finalize_f(int64_t* handler)
