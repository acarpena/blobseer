/**
 * Provides the means for describing preceded by relation.
 * 
 ...
 */
public class PrecededBy extends ComplexXMLElem {
	
	private Boolean refEventSet;
	private Boolean countSet;
	private Boolean distSet; 
	
	public PrecededBy(String id) throws Exception {
		super("precededBy", id, null);
