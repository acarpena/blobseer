...
if (len(sys.argv) == 5) :
    ...
    oar_tools_grid.execute_command(clients, ["/home/rennes/jcai/deploy/workload/random_client.sh", bs_file,
                                       str(num_blobs)])

else :
    print "use: "+ sys.argv[0] + " <nodes list file> <blobseer config file> <num clients> <num blobs>"
