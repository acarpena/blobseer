...
int main(int argc, char *argv[]) {   
    ...
    // Monitoring Listener!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    pmanager_mon_listener mon_listener(filename);    
    adv_storage.add_listener(boost::bind(&pmanager_mon_listener::update_event, 
    ...
    provider_server.register_rpc(PUBLISHER_GET,
				 (rpcserver_extcallback_t)boost::bind(&adv_manager::get, boost::ref(adv_storage), _1, _2, _3));
