 ...
 * @author tylor
 */
public class blob_version_over_page {
   ...
   public String getchart_type()
    ...
    private XYDataset getDataSet()
    {
        ...
        XYSeriesCollection coll = new XYSeriesCollection(null);
       ...
       // double stop_x=0;
        ...
        {
            XYSeries series = new XYSeries("v"+v);
            db.query("select min(blob_offset),max(blob_offset) from blob_pages where written_version="+v+" and blob_id="+blob_id);
            db.moveNext();
            start_x = db.getd(1);
            end_x = db.getd(2);
        ...
        XYDataset xyDataset=coll;
        return xyDataset;
    }
    


    private CategoryTableXYDataset getDataSet_stackedXYArea()
    {
