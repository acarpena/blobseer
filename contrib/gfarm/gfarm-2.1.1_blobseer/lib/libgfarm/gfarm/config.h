...
//TRAN begin
/* BlobSeer dependent*/
extern char *STR_BLOB_REPLICA_COUNT; 	
extern char *STR_BLOB_PAGE_SIZE; 	//1048576 page size = 1MB
extern char *BLOB_CONFIGURATION; 	//E.g "/media/Programfiles/opt/blobseer/release-0.1/lib/test.cfg"

extern int BLOB_REPLICA_COUNT; 		
extern int BLOB_PAGE_SIZE; 		//1048576 page size = 1MB
//TRAN end
