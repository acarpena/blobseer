...
gfarm_error_t
gfs_client_fget_version_count(struct gfs_connection *gfs_server, gfarm_int32_t fd, size_t * nversion)
{
	gfs_client_connection_used(gfs_server);

        return (gfs_client_rpc(gfs_server, 0, GFS_PROTO_FGET_VERSION_COUNT, "i/i",
	    fd, nversion));
...
gfarm_error_t
gfs_client_fset_version(struct gfs_connection *gfs_server, gfarm_int32_t fd, size_t nversion, size_t * nactive_version)
{
	gfs_client_connection_used(gfs_server);
//	nversion = 45;
        return (gfs_client_rpc(gfs_server, 0, GFS_PROTO_FSET_VERSION, "ii/i",fd,nversion,nactive_version));
...
gfarm_error_t
gfs_client_fget_current_version(struct gfs_connection *gfs_server, gfarm_int32_t fd, size_t *nversion)
{
  	return (GFARM_ERR_NO_ERROR);

}
gfarm_error_t
gfs_client_vread(struct gfs_connection *gfs_server, gfarm_int32_t fd,
                               size_t nversion, void *buffer, size_t size, gfarm_off_t off, size_t *np)
{
	return (GFARM_ERR_NO_ERROR);
