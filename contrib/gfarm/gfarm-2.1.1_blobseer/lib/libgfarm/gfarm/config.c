/*
 * $Id: config.c 3959 2008-05-08 17:14:53Z tatebe $
 */
...
//TRAN
/* BlobSeer dependent*/
char *STR_BLOB_REPLICA_COUNT =NULL; 		// 1
char *STR_BLOB_PAGE_SIZE = NULL; 			//4194304//2097152//1048576//67108864//1048576 //8 page size = 1MB
char *BLOB_CONFIGURATION = NULL; 	//"/media/Programfiles/opt/blobseer/release-0.1/lib/test.cfg"
int BLOB_REPLICA_COUNT = 1; 		// 1
int BLOB_PAGE_SIZE = 1048576; 			//4194304//2097152//1048576//67108864//1048576 //8 page size = 1MB
...
parse_one_line(char *s, char *p, char **op)
{
	...
	//TRAN blobseer config parametters
	} else if (strcmp(s, o = "BLOB_REPLICA_COUNT") == 0) {
			e = parse_set_var(p, &STR_BLOB_REPLICA_COUNT);
			BLOB_REPLICA_COUNT = strtol(STR_BLOB_REPLICA_COUNT,NULL,0);
	} else if (strcmp(s, o = "BLOB_PAGE_SIZE") == 0) {
				e = parse_set_var(p, &STR_BLOB_PAGE_SIZE);
				BLOB_PAGE_SIZE = strtol(STR_BLOB_PAGE_SIZE,NULL,0);
	} else if (strcmp(s, o = "BLOB_CONFIGURATION") == 0) {
				e = parse_set_var(p, &BLOB_CONFIGURATION);
	//TRAN end
