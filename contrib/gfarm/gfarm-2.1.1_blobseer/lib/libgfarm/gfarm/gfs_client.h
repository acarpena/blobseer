...
gfarm_error_t gfs_client_fget_version_count(struct gfs_connection *, gfarm_int32_t, size_t *);
gfarm_error_t gfs_client_fset_version(struct gfs_connection *, gfarm_int32_t, size_t, size_t *);
gfarm_error_t gfs_client_fget_current_version(struct gfs_connection *, gfarm_int32_t, size_t *);
gfarm_error_t gfs_client_vread(struct gfs_connection *, gfarm_int32_t,size_t, void *, size_t, gfarm_off_t, size_t *);
