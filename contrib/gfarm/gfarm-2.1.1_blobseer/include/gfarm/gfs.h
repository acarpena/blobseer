/*
 * $Id: gfs.h 4016 2008-09-10 16:04:16Z tatebe $
 */
...
#endif
//TRAN  begining
gfarm_error_t gfs_get_active_version(GFS_File,size_t *);
gfarm_error_t gfs_get_latest_version(GFS_File,size_t *);
gfarm_error_t gfs_set_version(GFS_File,size_t, size_t *);
gfarm_error_t gfs_pio_vread(size_t, GFS_File, void *, int, int *);
//TRAN end
