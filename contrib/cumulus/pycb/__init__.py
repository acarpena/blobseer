...
from cbBlobseerBackend import cbBlobseerBackend
    ...
    def load_settings(self):
        ...
        for cp in config_path:
            ...
            try:
                ...
                if backend == "blobseer":
                    config_file = s.get("backend", "config_file")
                    print "loading bs backend..."
                    self.bucket = cbBlobseerBackend(config_file)

                try:
                    self.block_size = long(s.get("backend", "block_size"))
                except:
                    pass
            except:
                pass
