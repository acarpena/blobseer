...
public:
	...
	typedef std::pair<metadata::list_query_t, root_flag_t> list_query_root_flag_t;
	typedef std::pair<int, list_query_root_flag_t> interval_entry_t;
	typedef std::map<int, list_query_root_flag_t> interval_list_t;
